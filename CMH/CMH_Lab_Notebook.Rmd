...
* Introduce heterogeneity in workplace network: e.g. some networks dissolved under shelter in place, others persist (essential workers)  
...
* Transfer some functions to C++ to speed up?  
